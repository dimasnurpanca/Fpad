...
public class KategoriStoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public KategoriStoryViewHolder(View itemView, Context context, ArrayList<StoryList> data) {
        super(itemView);
