...
public class DraftsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public DraftsViewHolder(View itemView, Context context, ArrayList<StoryList> data) {
        super(itemView);
        textView1 = (TextView) itemView.findViewById(R.id.title);
        textView2 = (TextView) itemView.findViewById(R.id.lastupdate);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.view:
                                Intent i1 = new Intent(mContext,ReadStoryActivity.class);
    ...
    public void title(String text) {
        if(text.equals("")){
            textView1.setText(mContext.getResources().getString(R.string.default_no_title_drafts));
        }else {
    ...
    public void lastupdate(String text) {
        if(text.equals("")){
            textView2.setText(mContext.getResources().getString(R.string.default_last_update)+"-");
        }else {
            textView2.setText(mContext.getResources().getString(R.string.default_last_update)+text);
        }
    }
