...
public class ReadingListsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ReadingListsViewHolder(View itemView, Context context, ArrayList<StoryList> data) {
        super(itemView);
